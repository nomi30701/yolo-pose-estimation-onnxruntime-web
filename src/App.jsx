        ...
        >
          {activeFeature === "image" ? (
            <>
              ...
              <span className="truncate">Close Image</span>
            </>
          ) : (
            <>
              <svg
        ...
        >
          {activeFeature === "camera" ? (
            <>
              ...
              <span className="truncate">Close Camera</span>
            </>
          ) : (
            <>
              <svg
                    ...
                    >
                      ...
                      <td className="p-2 sm:p-3 text-xs sm:text-sm">
                        <div className="flex items-center">
                          <div className="w-full bg-gray-600 rounded-full h-1.5 sm:h-2.5 mr-1 sm:mr-2 max-w-[100px] sm:max-w-[150px]">
                            <div
...
function App() {
  ...
  const loadModel = useCallback(async () => {
    ...
    const model_path = customModel
      ? customModel.url
      : `${window.location.href}/models/${modelConfig.model}-pose.onnx`;
  ...
  const handle_ImageLoad = useCallback(async () => {
    ...
    try {
      ...
      await render_overlay(results, overlayCtx);
