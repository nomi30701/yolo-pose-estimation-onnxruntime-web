...
function App() {
  ...
  return (
    <>
      <h1 className="my-8 text-4xl">Yolo Pose estimation</h1>
      ...
      >
        ...
        <div id="model-selector-container">
          ...
          <select name="model-selector" ref={modelRef} onChange={loadModel}>
            ...
            <option value="yolo11n-pose-simplify-dynamic">yolo11n-2.6M</option>
            <option value="yolo11s-pose-simplify-dynamic">yolo11s-9.4M</option>
